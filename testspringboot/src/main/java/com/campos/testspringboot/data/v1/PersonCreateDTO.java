...
public class PersonCreateDTO {
    ...
    public PersonCreateDTO(String firstName, String lastName, String email, String phoneNumber, String password, Date birthDate, String address, String state, String gender) {
